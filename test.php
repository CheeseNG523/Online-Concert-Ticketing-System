<?php
    ...
    $query = "SELECT * FROM concert, venue WHERE concert.Venue_ID = venue.Venue_ID AND concert.Concert_Unable = 0 AND concert.Concert_Status = 1 ORDER BY Concert_StartDate";
