...
<script src="js/ckeditor/ckeditor.js"></script>
    <div class="page_position">
        ...
        <div class="position_right">
            ...
            <label><span class="material-icons direction_arr">keyboard_arrow_right</span></label>
            <label class="current_direction">Update Singer</label>
        </div>
    </div>
    <div class="page_position">
    <div class="page_form">              
    <div class='back-to-prev' onclick="history.back()"><span class="material-icons">arrow_back_ios</span>Back</div>
        ...
        <div class="container" style="padding:45px;">
            <div class="page">
                <div class="title">Update Singer</div>
                <div>
                    <input class="singer_id" type="text" name="id" hidden value="<?php echo $row['Singer_ID'];?>">
                    <div class="txt_field" style="float:left;width:38%">
                        <input type="text" class="checking_updated_singer_name" name="singer_name" value="<?php echo $row['Singer_Name']?>">
                    ...
                    <div class="txt_field" style="float:left; width:58%; margin-left:4%">
                        <select class="checking_singer_cate" name="singer_cate">
                            ...
                            {
                                ?>
                                <option value="<?php echo $result_run['Category_ID'];?>"
                                <?php
                                if($row['Category_ID'] == $result_run['Category_ID'])
                                    echo "selected";
                                ?>
                                ><?php echo $result_run['Category_Name'];?></option>
                                <?php
                            }
                            ?>
                        </select>
                ...
                <div style="float:left; width:58%; margin: 0 0 0 4%;">
                    <div class="txt_field" style="clear:both; margin-top:0">
                        <textarea rows="16" cols="50" class="checking_SDescrip" style="resize: none; padding:9px;" id="ckeditor" name="singer_desc"><?php echo $row['Singer_Desc'];?></textarea>
                        <label>Singer Description</label>
                    </div>
                </div>
                <div class="button_field">
                    <button class="singer_update_submit_btn" type="button" disabled="disabled">Update Singer</button>
...
<script>
    ...
    CKEDITOR.instances.ckeditor.on('key', function(e) {
        $('.singer_update_submit_btn').prop("disabled","");
    });

    $('.update_singer_form').keyup(function()
    {   
        $('.singer_update_submit_btn').prop("disabled","");
    });

    $('.update_singer_form').change(function()
    {   
        $('.singer_update_submit_btn').prop("disabled","");
    });
