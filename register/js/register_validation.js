$(document).ready(function (){
    ...
    $('.checking_gender').keyup(function(){
        var fname_valid = $('.checking_gender').val();
        $.ajax({
            type: "POST",
            url: "register_validation.php",
    ...
    $('.checking_address').keyup(function(){
        var address_valid = $('.checking_address').val();
        $.ajax({
            type: "POST",
            url: "register_validation.php",
    ...
    $('.checking_postcode').keyup(function(){
        var postcode_valid = $('.checking_postcode').val();
        $.ajax({
            type: "POST",
            url: "register_validation.php",
