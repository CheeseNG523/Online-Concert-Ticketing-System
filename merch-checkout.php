    ...
    <?php
        ...
        $cust_info = $result;
            ...
            if($result['Cust_Address']==null||$result['Cust_Address']=="")
            {
                ...
                echo "<input class='fulladdress' type='text' name='full-address' placeholder='" . $result['Cust_Address']. "'></input>";
                echo "</div>";
                ...
                echo "<div class='half-right' style='grid-column: 3/6;'>";
                    ...
                    echo "<input class='city' type='text' name='city' placeholder='" . $result['Cust_City']. "'></input>";
                echo "</div>";
                echo "<div class='half-right' style='grid-column: 1/3;'>";
                    echo "<label for='postcode'>Postcode</label>";
                    echo "<input class='postcode' type='text' onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength='5' name='postcode' placeholder='" . $result['Cust_Postcode'] . "'></input>";
                echo "</div>";
            }
            else
            {
                ...
                echo "<div class='half-left' style='width: 166%'>";
                echo "<label for='full-address'>Full Address</label>";
                echo "<input type='text' class='fulladdress' name='full-address' value='" . $result['Cust_Address']. "' readonly='readonly'></input>";
                echo "</div>";
                echo "<div class='half-left' style='grid-column: 1/3;'>";
                echo "<label for='state'>State</label>";
                ...
                echo "<div class='half-right' style='grid-column: 3/6;'>";
                    echo "<label for='city'>City</label>";
                    echo "<input type='text' id='city' class='city' name='city' value='" . $result['Cust_City']. "' readonly='readonly'></input>";
                echo "</div>";
                echo "<div class='half-right' style='grid-column: 1/3;'>";
                    echo "<label for='postcode'>Postcode</label>";
...
$(document).ready(function(){
    ...
    $('.defaultbtn').on('click',function(e){
        ...
        $('.fulladdress').val(custInfo.Cust_Address);
    ...
    $('.pay_out').on('click',function(event){
        ...
        //address validation
        if($('.fulladdress').val()==""||$('.state').val()==""||$('.city').val()==""||$('.postcode').val()=="")
        {
            f = 1;
            console.log(f);
        }
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(respone)
                                    {
                                        ...
                                        console.log('Line 680 : Purchase ID:'+payment_id);
                                        Swal.fire({
                        ...
                        else
                        {
                            ...
                            $.ajax({
                                ...
                                success: function(respone)
                                {
                                    console.log(respone);
                                    var otp = respone[0];
                                    console.log('Line 792 : Pusrchase ID:'+respone[2]);
                                    Swal.fire({
                                        title: 'Please enter your OTP',
                                        input: 'text',
                                        allowOutsideClick: false,
                                                ...
                                                $.ajax({
                                                    ...
                                                    success:function(data)
                                                    {
                                                        ...
                                                        Swal.fire({
                                                            ...
                                                            text:'Purchase made successfully!', 
                                                            icon:'success',
                                                            didClose: () => window.open('merch_payment_out.php?view&id='+respone[2],'_self')});
                                                    },
                                                    error:function(data)
                                                    {
                                                        console.log(data);
        ...
        //if address field is not all filled in
        else if(f==1)
        {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Please fill in complete address'
            })
        }
